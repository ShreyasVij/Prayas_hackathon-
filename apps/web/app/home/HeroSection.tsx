    ...
    <section className="relative overflow-hidden pt-8 pb-16 md:pt-14 md:pb-24">
      <HeroHighlight className="w-full">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            Transform scattered lab reports and prescriptions into verified
            clinical intelligence. Instant emergency QR access, longitudinal
            vitals analysis, and doctor-grade AI summaries.
          </motion.p>
          ...
          >
            ...
            >
              <span>
                {isAuthed ? "Launch Dashboard" : "Sign In to Access Vault"}
              </span>
          ...
          >
            <CardSpotlight
              className="p-6 md:p-8 bg-white/90 backdrop-blur border border-slate-200/90 shadow-2xl rounded-3xl text-left"
              ...
              <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-3">
                      <span className="text-[11px] font-bold uppercase tracking-wider text-teal-700">
                        Live AI Health Brief
                      </span>
                      <AIBadge />
                    </div>

                    <p className="text-zinc-800 font-medium text-sm leading-relaxed">
                      Cardiovascular biomarkers show healthy recovery. Resting
                      heart rate is stable at{" "}
                      <span className="font-bold text-teal-700">72 bpm</span>{" "}
                      with blood pressure well within optimal limits (
                      <span className="font-bold text-teal-700">
                        118/76 mmHg
                      </span>
                      ). Fasting blood glucose improved by 7% post dietary
                      adjustment.
                    </p>
                  </div>
                ...
                <div className="p-5 rounded-2xl bg-white border border-rose-200 shadow-sm flex flex-col items-center justify-between text-center relative overflow-hidden">
                  <div className="w-full flex items-center justify-between pb-2 mb-2 border-b border-rose-100">
                    ...
                    <span className="px-2 py-0.5 rounded text-[9px] font-bold bg-rose-100 text-rose-700">
                      LIVE
                    </span>
                  </div>
                  ...
                  <p className="text-[11px] font-semibold text-zinc-900 mt-1">
                    EMERGENCY ACCESS
                  </p>

                  <p className="text-[10px] text-zinc-500">
                    Scan for Blood Type, Allergies &amp; ER Contacts
                  </p>
                </div>
                ...
                <div className="p-5 rounded-2xl bg-white border border-slate-200/80 shadow-sm flex flex-col justify-between">
                  ...
                  <div>
                    ...
                    <div className="text-xs text-emerald-600 font-semibold mt-0.5">
                      &darr; 4 bpm vs last month &bull; Optimal
                    </div>
                  </div>

                  <div className="h-10 mt-3 flex items-end gap-1.5">
                    {[40, 65, 55, 80, 60, 75, 70, 85, 72].map(
                      (val, idx) => (
                        <div
                          key={idx}
                ...
                <div className="md:col-span-2 p-5 rounded-2xl bg-white border border-slate-200/80 shadow-sm flex flex-col justify-between">
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      {
                        name: "Cardiology_Stress_Test.pdf",
                        type: "Specialist",
                        status: "FLAGGED",
                        color:
                      ...
                      >
                        ...
                        <span
                          className={`px-2 py-0.5 rounded-full text-[10px] font-bold border ${item.color}`}
                        >
                          {item.status}
                        </span>
                      </div>
